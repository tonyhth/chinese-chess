...
void Search::Worker::start_searching() {
    ...
    Skill   skill{int(options["Skill Level"])};
...
// Skill::pick_best - adapted from Stockfish
// Choose a sub-optimal move based on skill level
Move Search::Skill::pick_best(const RootMoves& rootMoves, usize multiPV) {
    static PRNG rng(now());
