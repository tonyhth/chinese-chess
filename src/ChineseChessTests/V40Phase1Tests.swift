...
struct MoveHangFixTests {
    ...
    func stalemateIsLoss() {
        ...
        let bh1 = TestPieceFactory.makePiece(kind: .horse, side: .black, position: Position(row: 5, col: 2))
        let bh2 = TestPieceFactory.makePiece(kind: .horse, side: .black, position: Position(row: 5, col: 6))
