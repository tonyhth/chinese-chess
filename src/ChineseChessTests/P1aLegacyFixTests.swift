...
struct P1aLegacyFixTests {
    ...
    func checkmateSearchSimpleCheckmate() {
        ...
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 6, timeLimitMs: 3000)
    ...
    func checkmateSearchNoCheckmate() {
        // 标准开局，不可能将杀
        let board = Board()
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 4, timeLimitMs: 1000)
    ...
    func checkmateSearchTimeout() {
        let board = Board()
        // 极短超时
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 20, timeLimitMs: 1)
    ...
    func checkmateSearchDepthZero() {
        let board = Board()
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 0, timeLimitMs: 1000)
    ...
    func checkmateSearchDepthTwo() {
        let board = Board()
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 2, timeLimitMs: 1000)
        // 标准开局 2 层不可能将杀
    ...
    func checkmateSearchOpponentOnlyKing() {
        ...
        let result = CheckmateSearch.search(board: board, for: .red, maxDepth: 8, timeLimitMs: 3000)
        // 車帅 vs 单将，应该能找到将杀
