...
// 宽度约束：minWidth 400（与 ManagedSplitView.rightMin 一致；v6.2.1 380→400，
// Ruby P1-1：VTF 死区 364-388、392 恢复，380 落死区）/ maxWidth 500。
//
...
struct DemoSidePanel<Header: View, Footer: View>: View {
    ...
    var body: some View {
        ...
        // 面板宽度约束（v6.2.1：min/ideal 400——VTF 恢复点 392 + 余量 / max 500）
