...
- **1a30749** chore(phase-3): P3-0 顺手件四件——R2 回退面
- **cbb645a** fix(phase-3): P3-① 双快路径——R2 回退面
- **0c79d6d** feat(phase-3): P3-②③ 甲口径单遍化 + QS——R2 回退面
- **daf4f14** test(phase-3): P3-④ 专项集——R2 回退面（测试随面退场）
- **7ed795a** fix(phase-2): P2×2 测试清偿——R2 回退面（测试随面退场）
